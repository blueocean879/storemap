              ...
              <!-- general form elements -->
                <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="store_phone" name="store_phone" placeholder="Store Phone">
                  </div>

                  <div class="form-group">
                    <label class="text control-label" for="store_email"> Email</label>
                    <input type="text" class="form-control" id="store_email" name="store_email" placeholder="Store Email">
                  </div>

                  <div class="form-group">
                    <label class="text control-label" for="store_url"> URL</label>
                    <input type="text" class="form-control" id="store_url" name="store_url" placeholder="Store URL">
                  </div>

                  <div class="form-group">
                    <label class="text control-label" for="store_description"> Description</label>
                    <textarea class="form-control" rows="3" placeholder="Enter ..." name="store_description"></textarea>
                  </div>
            ...
            <div class="col-md-6">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" rows="3" placeholder="" name="store_promomessage"></textarea>
                </div>

                <div class="form-group">
                  <label class="text control-label" for="store_custom_field_1"> Custom Field 1</label>
                  <input type="text" class="form-control" id="store_custom_field_1" name="store_custom_field_1" placeholder="">
                </div>

                <div class="form-group">
                  <label class="text control-label" for="store_custom_field_2"> Custom Field 2</label>
                  <input type="text" class="form-control" id="store_custom_field_2" name="store_custom_field_2" placeholder="">
                </div>

                <div class="form-group">
                  <label class="text control-label" for="store_custom_field_3"> Custom Field 3</label>
                  <input type="text" class="form-control" id="store_custom_field_3" name="store_custom_field_3" placeholder="">
                </div>

                <div class="form-group">
                  <label class="text control-label" for="store_custom_marker_image"> Custom Marker Image</label>
                  <textarea class="form-control" rows="3" placeholder="Enter ..." name="store_custom_marker_image"></textarea>
                </div>
  ...
  $(function () {
    ...
    $("#addStoreForm").submit(function(event) {
       //disable the submit button to prevent repeated clicks
        ...
        var xmlURL = "https://maps.google.com/maps/api/geocode/json?address=" + encodeURI($('#store_address').val()) + "&key=AIzaSyC7v5tPcwo4wXY1mU3PUtXpcxReRcrjsXE";
